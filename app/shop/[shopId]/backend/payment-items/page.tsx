...
import { PaymentItemsView } from "@/src/presentation/components/shop/backend/PaymentItemsView";
import { PaymentItemsPresenterFactory } from "@/src/presentation/presenters/shop/backend/PaymentItemsPresenter";
...
interface PaymentItemsPageProps {
...
export async function generateMetadata({
  ...
  try {
    ...
    // Fallback metadata
    return {
      title: "จัดการรายการชำระเงิน - เจ้าของร้าน | Shop Queue",
      description: "จัดการรายการบริการที่ชำระเงิน ดูสถิติการขาย และรายได้",
    };
  }
}
...
export default async function PaymentItemsPage({
  ...
  try {
    ...
    console.error("Error fetching payment items data:", error);
