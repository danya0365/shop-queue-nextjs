...
interface RewardTransactionsPageProps {
  ...
  searchParams: Promise<{ status?: string; rewardType?: string; page?: string; limit?: string }>;
}

export async function generateMetadata({ params }: RewardTransactionsPageProps): Promise<Metadata> {
  ...
  try {
    ...
    console.error('Error generating metadata for reward transactions page:', error);
    return {
...
export default async function RewardTransactionsPage({ params, searchParams }: RewardTransactionsPageProps) {
  const { shopId } = await params;
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-red-700">
                  <p>ไม่สามารถโหลดข้อมูลประวัติการแลกรางวัลได้ กรุณาลองใหม่อีกครั้ง</p>
