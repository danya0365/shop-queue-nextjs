...
import { ProfilesView } from "@/src/presentation/components/backend/profiles/ProfilesView";
import { ProfilesPresenterFactory } from "@/src/presentation/presenters/backend/profiles/ProfilesPresenter";
...
export async function generateMetadata(): Promise<Metadata> {
  const presenter = await ProfilesPresenterFactory.create();
...
/**
 * Profiles page - Server Component for SEO optimization
      ...
      <BackendLayout>
        <div className="min-h-screen backend-bg flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="backend-text-muted mb-4">ไม่สามารถโหลดข้อมูลโปรไฟล์ได้</p>
            <Link
              href="/backend"
