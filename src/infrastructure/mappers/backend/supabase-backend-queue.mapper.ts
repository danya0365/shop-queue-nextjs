import { QueueEntity, QueuePriority, QueueServiceEntity, QueueStatsEntity, QueueStatus } from "../../../domain/entities/backend/backend-queue.entity";
 ...
 */
export class SupabaseBackendQueueMapper {
  /**
   ...
   */
  public static toDomain(schema: QueueSchema, services: QueueServiceSchema[] = []): QueueEntity {
    return {
      id: schema.id,
