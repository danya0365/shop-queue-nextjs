...
export class ShopContactPresenter extends BaseSubscriptionPresenter {
  ...
  async getViewModel(): Promise<ShopContactViewModel> {
    try {
      ...
      const faqs: FAQ[] = [
        {
          ...
          answer: "Shop Queue เป็นแพลตฟอร์มจัดการคิวร้านค้าที่ช่วยให้ธุรกิจสามารถจัดการลูกค้าได้อย่างมีประสิทธิภาพ และลูกค้าสามารถจองคิวล่วงหน้าได้",
          category: "ทั่วไป"
        },
        {
          id: "2",
          question: "การใช้งานมีค่าใช้จ่ายหรือไม่?",
          answer: "เรามีแพ็กเกจที่หลากหลาย เริ่มตั้งแต่แพ็กเกจฟรีสำหรับร้านค้าขนาดเล็ก ไปจนถึงแพ็กเกจระดับองค์กรสำหรับธุรกิจขนาดใหญ่",
          category: "ราคา"
        },
        {
          id: "3",
          question: "สามารถทดลองใช้ฟรีได้หรือไม่?",
          answer: "ได้ครับ เรามีช่วงทดลองใช้ฟรี 30 วัน พร้อมฟีเจอร์ครบครันทุกอย่าง ไม่มีข้อจำกัด",
          category: "ทดลองใช้"
        },
        {
          id: "4",
          question: "รองรับร้านค้าประเภทไหนบ้าง?",
          answer: "รองรับร้านค้าทุกประเภท เช่น ร้านอาหาร คลินิก ร้านเสื้อผ้า ร้านตัดผม สปา และอื่นๆ อีกมากมาย",
          category: "ทั่วไป"
        },
        {
          id: "5",
          question: "มีการสนับสนุนลูกค้าอย่างไร?",
          answer: "เรามีทีมสนับสนุนลูกค้า 24/7 ผ่านโทรศัพท์ อีเมล แชทสด และ LINE Official Account",
          category: "สนับสนุน"
        },
        {
          id: "6",
          question: "ข้อมูลปลอดภัยหรือไม่?",
          answer: "ข้อมูลของคุณปลอดภัยด้วยระบบเข้ารหัส SSL และเก็บข้อมูลบนเซิร์ฟเวอร์ที่ได้มาตรฐานสากล",
      ...
      this.logger.error("ShopContactPresenter: Error getting view model", { error });
  ...
  async submitContactForm(formData: ContactFormData): Promise<{ success: boolean; message: string }> {
    try {
      ...
      this.logger.error("ShopContactPresenter: Error submitting contact form", { error });
      return {
        success: false,
  ...
  async getFAQsByCategory(category?: string): Promise<FAQ[]> {
    try {
      this.logger.info("ShopContactPresenter: Getting FAQs by category", { category });
      ...
      this.logger.error("ShopContactPresenter: Error getting FAQs by category", { error });
      return [];
    }
  }
}
