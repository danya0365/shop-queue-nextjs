  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">ชำระเงิน</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">จัดการการชำระเงินและออกใบเสร็จ</p>
        </div>
