    ...
    return (
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">ไม่พบการตั้งค่าการแจ้งเตือน</h3>
          <p className="text-gray-500 dark:text-gray-400">กรุณาติดต่อผู้ดูแลระบบเพื่อตั้งค่าเริ่มต้น</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-8">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500 dark:text-gray-400">{category.settingsCount} การตั้งค่า</div>
                      </div>
                    </div>
                    <div className={`w-2 h-2 rounded-full ${
                      category.enabled ? 'bg-green-400' : 'bg-gray-300 dark:bg-gray-600'
                    }`} />
                  </div>
                </button>
              ))}
            ...
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{selectedCategoryData?.name}</h3>
                    <p className="text-gray-600 dark:text-gray-400">{selectedCategoryData?.description}</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <span className="text-sm text-gray-500 dark:text-gray-400 mr-2">เปิดใช้งาน</span>
                  <div className={`w-12 h-6 rounded-full p-1 transition-colors ${
                    selectedCategoryData?.enabled ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'
                  }`}>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex justify-between items-center">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">เทมเพลตการแจ้งเตือน</h3>
              <p className="text-gray-600 dark:text-gray-400">จัดการข้อความแจ้งเตือนสำหรับแต่ละประเภท</p>
            </div>
          </div>
        </div>
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {templates.map((template) => (
              <div key={template.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-md transition-shadow bg-white dark:bg-gray-800">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">{template.type.toUpperCase()}</p>
                    </div>
                  </div>
                  <div className={`w-2 h-2 rounded-full ${
                    template.isActive ? 'bg-green-400' : 'bg-gray-300 dark:bg-gray-600'
                  }`} />
                </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">การแจ้งเตือนล่าสุด</h3>
          <p className="text-gray-600 dark:text-gray-400">ประวัติการส่งการแจ้งเตือนล่าสุด</p>
        </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-gray-700">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">เหตุการณ์</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">ผู้รับ</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">สถานะ</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">เวลาส่ง</th>
              </tr>
            </thead>
      ...
      {showTestModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">ทดสอบการส่งการแจ้งเตือน</h3>
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">ผู้รับ</label>
                <input
                  type="text"
                  value={testRecipient}
