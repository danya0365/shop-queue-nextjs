        ...
        <div className="text-center">
          ...
          <div className="text-sm text-gray-500 mb-6">
            {queueNumber && customerName ? (
              <p>
                คุณแน่ใจหรือไม่ว่าต้องการลบคิว <span className="font-semibold text-gray-900">#{queueNumber}</span> ของลูกค้า <span className="font-semibold text-gray-900">{customerName}</span>?
              </p>
            ) : (
