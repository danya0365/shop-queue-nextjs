      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <Link href="/" className="text-xl sm:text-2xl font-bold frontend-header-text">
              Shop Queue
            </Link>
            <span className="hidden sm:inline frontend-header-text-muted">|</span>
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            <ThemeToggle />
            <button className="frontend-button-primary px-3 sm:px-4 py-2 rounded-lg transition-colors text-sm font-medium">
