...
const BackendSidebar: React.FC<BackendSidebarProps> = ({ sidebarOpen }) => {
  ...
  const navItems = [
    ...
    { href: '/backend/users', label: 'จัดการผู้ใช้', icon: Users },
    { href: '/backend/videos', label: 'จัดการวิดีโอ', icon: Film },
    { href: '/backend/categories', label: 'จัดการหมวดหมู่', icon: FolderTree },
