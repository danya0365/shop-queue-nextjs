    ...
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full rounded-lg border px-3 py-2 text-sm shadow-sm transition focus:outline-none focus:ring-2 focus:ring-primary ${errors.newPassword ? "border-error" : "border-border"}`}
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full rounded-lg border px-3 py-2 text-sm shadow-sm transition focus:outline-none focus:ring-2 focus:ring-primary ${errors.confirmPassword ? "border-error" : "border-border"}`}
      ...
      <div className="flex justify-end">
        <button
          type="submit"
          disabled={loading}
          className="inline-flex items-center justify-center rounded-lg bg-primary px-4 py-2 text-sm font-medium text-white transition hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50"
        >
