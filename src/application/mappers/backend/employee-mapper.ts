import { EmployeeDTO, EmployeeStatsDTO, PaginatedEmployeesDTO } from '@/src/application/dtos/backend/employees-dto';
import { EmployeeEntity, EmployeeStatsEntity, PaginatedEmployeesEntity } from '@/src/domain/entities/backend/backend-employee.entity';
