import { QueueDTO, QueueStatsDTO } from '@/src/application/dtos/backend/queues-dto';
import { QueueEntity, QueueStatsEntity } from '@/src/domain/entities/backend/backend-queue.entity';
