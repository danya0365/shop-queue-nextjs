import { CustomerDTO, CustomerStatsDTO } from '@/src/application/dtos/backend/customers-dto';
import { CustomerEntity, CustomerStatsEntity } from '@/src/domain/entities/backend/backend-customer.entity';
