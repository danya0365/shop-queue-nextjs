import { DepartmentDTO, DepartmentStatsDTO, DepartmentsDataDTO } from '@/src/application/dtos/shop/backend/department-dto';
import { DepartmentEntity, DepartmentStatsEntity, PaginatedDepartmentsEntity } from '@/src/domain/entities/shop/backend/backend-department.entity';
