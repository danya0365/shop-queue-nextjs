import { PaginatedPromotionsDTO, PromotionDTO, PromotionStatsDTO } from '@/src/application/dtos/shop/backend/promotions-dto';
import { PaginatedPromotionsEntity, PromotionEntity, PromotionStatsEntity } from '@/src/domain/entities/shop/backend/backend-promotion.entity';
