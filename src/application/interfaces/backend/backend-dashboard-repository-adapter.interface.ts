...
/**
 * Interface for Backend Dashboard Repository Adapter
 * Following SOLID principles by defining a focused interface for backend dashboard operations
 */
export interface IBackendDashboardRepositoryAdapter {
  /**
   ...
   */
  getDailyViews(days?: number): Promise<DailyViewsDto>;
   ...
   */
  getMonthlyNewVideos(months?: number): Promise<MonthlyNewVideosDto>;
}
