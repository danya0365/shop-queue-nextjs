import { CreateProfileSubscriptionInputDTO, ProfileSubscriptionDTO } from '@/src/application/dtos/subscription/backend/subscription-dto';
import { IUseCase } from '@/src/application/interfaces/use-case.interface';
import { SubscriptionMapper } from '@/src/application/mappers/subscription/backend/subscription-mapper';
import { CreateProfileSubscriptionEntity, SubscriptionStatus, BillingPeriod } from '@/src/domain/entities/subscription/backend/backend-subscription.entity';
