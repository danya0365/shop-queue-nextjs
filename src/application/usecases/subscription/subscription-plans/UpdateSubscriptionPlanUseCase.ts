import { SubscriptionPlanDTO, UpdateSubscriptionPlanInputDTO } from '@/src/application/dtos/backend/subscription-dto';
import { IUseCase } from '@/src/application/interfaces/use-case.interface';
import { SubscriptionMapper } from '@/src/application/mappers/backend/subscription-mapper';
import { UpdateSubscriptionPlanEntity } from '@/src/domain/entities/backend/backend-subscription.entity';
